<template>
  <div class="fixed top-4 right-4 z-50 space-y-2 max-w-xl">
    <TransitionGroup name="toast">
      <div
        v-for="toast in toasts"
        :key="toast.id"
        :class="[
          'w-auto min-w-[320px] bg-gray-800 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden',
          toast.show ? 'animate-slide-in' : 'animate-slide-out'
        ]"
      >
        <div class="p-4">
          <div class="flex items-start">
            ...
            <div class="ml-4 flex shrink-0">
              <button
                ...
                class="inline-flex rounded-md text-gray-400 hover:text-gray-300 focus:outline-none"
              >
